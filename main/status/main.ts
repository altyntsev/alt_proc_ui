...
import {Task, Event, Proc, Script} from "../_types.js"

declare var app: Main

interface TaskRes extends Task {
    n_events?: number
    n_wait_procs?: number
    n_run_procs?: number
    last_proc_status: 'WAIT' | 'RUN' | 'DONE' | 'DELETED'
    last_proc_result?: 'SUCCESS' | 'FATAL' | 'ERRORS'
    n_success_procs?: number
    n_fatal_procs?: number
    scripts: Script[]
}

interface Res {
    tasks: TaskRes[]
    launcher_mtime: string
    launcher_status: 'RUN' | 'PAUSE' | 'EXIT' | 'FATAL'
}
